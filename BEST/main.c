...
{
	setBaud(UART1, 600);
	//motor[/*name*/] = /*value*/; Command for setting motor value
	//vexRT[/*Channel or button*/] Command to get controller value
	//sendChar(UART1, /*IR Code*/); Command for sending IR Codes
}
