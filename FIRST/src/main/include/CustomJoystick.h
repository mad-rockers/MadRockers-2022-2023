...
class CustomJoystick : public Joystick {
  public:
    ...
    /**
     * Construct an instance of our custom joystick.
     *
     ...
     *             into (0-5).
     */
    explicit CustomJoystick(int port) : Joystick(port) {
       square_scale = false;
       deadzone = 0.1;
    };
     ...
     * 
     * @return The joystick X value from -1 to 1.
     */
    double GetX() {
      return GetRawAxis(Joystick::GetXChannel());
    }
     ...
     * This depends on the mapping of the joystick connected to the current port.
     * 
     * @return The joystick Y value from -1 to 1.
     */
    double GetY() {
      return GetRawAxis(Joystick::GetYChannel());
    }
